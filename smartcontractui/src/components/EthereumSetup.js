...
var smartContractAddress = '0xc48f368eafad65de8f34881946601b0b33353767';


ETHEREUM_CLIENT.eth.defaultAccount = ETHEREUM_CLIENT.eth.accounts[0];
// var gasPrice = ETHEREUM_CLIENT.eth.accounts;
// console.log(gasPrice.toString(10));
// ETHEREUM_CLIENT.eth.unlockAccount(ETHEREUM_CLIENT.eth.defaultAccount, "password", 15000)
...
// smartContract.addContract.sendTransaction(1, parts[i*31%(parts.length)], i+1*4*qty % 239, price*i+1*7%23, time*i+1*31%439, {from: ETHEREUM_CLIENT.eth.accounts[0], gas: 200000});
// for(i = 0; i < 5 ; i++) {
